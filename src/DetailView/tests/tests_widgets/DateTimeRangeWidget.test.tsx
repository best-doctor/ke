...
test('DateTimeRangeWidget widget should be rendered with wizard-name test id', () => {
...
test('DateTimeRangeWidget widget should be rendered with wizard-step-name test id', () => {
...
test('DateTimeRangeWidget widget should be rendered with step-name test id', () => {
